...
export async function logToExperienceLibrary(log: LogEntry) {
  // [GUARD] Firestore write disabled - free tier quota exhausted / independent version
  // Primary persistence is localStorage + Catbox. Do not write to Firestore by default.
